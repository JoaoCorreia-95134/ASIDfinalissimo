...
public class ClubController {
    ...
    public ResponseEntity<Club> addClubToStudent(@PathVariable("clubId") Long clubId, @PathVariable("studentId") Long studentId,  @RequestBody Student student) {
        System.out.println(student);
        Optional<Club> optionalClub = clubService.addClubToStudent(clubId, student);
